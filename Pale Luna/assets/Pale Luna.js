...
if (inicio === 1) {
    ...
    console.log (" ");
    console.log("---------------------------------------------------------------");
    console.log ("-> Você pegou a pá, talvez elas seja util no futuro");
...
while (jogoAtivo1) {
    ...
    if (floresta1 === 1) {
      ...
      if (Math.random() < 0.5) {
        ...
        console.log (" ");
        console.log("---------------------------------------------------------------");
        console.log ("-> Depois de pensar, você decidi ir pelo Leste, Você começa a adentrar a floresta densa...");
        saiudafloresta = true;
        jogoAtivo1 = false;
    }
}
...
while (jogoAtivo4) {
    ...
    if (floresta4 == 1) {
        ...
        if (carro == 1) {
            ...
            console.log ("---------------------------------------------------------------");
            console.log ("Opções:")
            console.log ("1. Ir embora, Isso não terá volta!!")
            ...
            console.log ("-> Isso não foi uma boa ideia! Um carro sem estar com o farol ligado, não te enxerga e tem mata atropelado.")
            console.log ("---------------------------------------------------------------");
            console.log ("-> Você Morreu!!")
            console.log ("---------------------------------------------------------------");
            console.log(" ██████   █████   ███    ███ ███████      ██████   ██    ██ ███████ ██████");
        ...
        if (casa2 == 1) {
            ...
            if (mapa3 == 1) {
                ...
                console.log ("-> Com receio de ter algo horrivél alí. Você se pergunta se deveria:")
                console.log ("---------------------------------------------------------------");
                console.log ("Opções:")
                ...
                console.log ("-> Então ele começa a procurar pelo invasor (Você).")
        ...
        console.log ("-> Onde ele basicamente fica dando voltas e voltas.")
